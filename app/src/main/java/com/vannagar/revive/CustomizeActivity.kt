...
class CustomizeActivity : ComponentActivity() {
                ...
                Row(
                    ...
                    ElevatedButton(
                        onClick = {
                            sharedPrefs.edit().putStringSet(
                                "PKG_NAME_LIST",
                                appList.filter{
                                    it.toggle && packageExists(it.packageName)
                    ...
                    ElevatedButton(
                        onClick = {
                            ...
                            startActivity(Intent(this@CustomizeActivity, LoginActivity::class.java))
                        },
                    ){
    ...
    private fun packageExists(packageName: String): Boolean {
        try {
            packageManager.getApplicationInfo(packageName, PackageManager.GET_META_DATA).enabled
